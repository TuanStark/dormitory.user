...
export default function RoomSummary({ bookingData }: RoomSummaryProps) {
  return (
      ...
      <div className="bg-gradient-to-br from-white to-blue-50 rounded-xl p-6 border border-gray-100 shadow-lg h-full">
        ...
        <div className="space-y-4">
          ...
          <div className="flex justify-between py-3 border-b border-gray-200">
            ...
            <span className="font-medium text-gray-600">{bookingData.startDate}</span>
          </div>
          
          <div className="flex justify-between py-3 border-b border-gray-200">
            <span className="text-gray-600">Thời gian lưu trú:</span>
            <span className="font-medium text-gray-600">{bookingData.stayDuration} ngày</span>
          </div>
