          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="mt-6">
                ...
                <div className="flex">
                  <input type="email" placeholder="Email của bạn" className="px-4 py-3 w-full rounded-l-lg focus:outline-none text-gray-900 bg-white" />
                  <button className="bg-blue-600 text-white px-4 py-3 rounded-r-lg hover:bg-blue-700 whitespace-nowrap">Đăng ký</button>
                </div>
              </div>
            </div>
          </div>
